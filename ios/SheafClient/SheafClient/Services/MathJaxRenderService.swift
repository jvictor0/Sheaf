...
final class MathJaxWorker: NSObject, WKNavigationDelegate {
    ...
    private func loadWorkerPageIfNeeded() {
        ...
        guard let url = workerHTMLURL() else {
            return
        }
    ...
    private func workerHTMLURL() -> URL? {
#if SWIFT_PACKAGE
        return Bundle.module.url(forResource: "mathjax-worker", withExtension: "html", subdirectory: "MathJax")
#else
        let bundle = Bundle.main
        return bundle.url(forResource: "mathjax-worker", withExtension: "html", subdirectory: "MathJax")
            ?? bundle.url(forResource: "mathjax-worker", withExtension: "html", subdirectory: "Resources/MathJax")
            ?? bundle.url(forResource: "mathjax-worker", withExtension: "html")
#endif
    }
